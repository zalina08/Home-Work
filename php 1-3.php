...
массива. Представим, что ключ вам заранее не известен. 
    ...
    г) сортировка по убыванию по ключу <br>
    ...
    <div class="Otvet">
        <?php
          ...
          {
          echo "Возраст ".$x." составляет: ".$x_value."<br>";
          }
...
делящиеся на 4.
Примечание. Не используйте управляющие операторы PHP. <br>
Ожидаемый результат:
200,204,208,212,216,220,224,228,232,236,240,244,248 
    </div> 
    <div class="Otvet">
        <?php
          $result = implode(",",range(200,250,4));  
        ?>
        <h3>Ответ: <?=$result ?> </h3>
    </div>
    <hr>
